    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap">
        <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
          <h1 class="font-bold text-4xl text-Hijau font-serif">Pine Residence</h1>
          <p class="mb-5">By OCBD</p>
          <h3 class="font-bold text-2xl mb-2">Contact Us</h3>
          <p>Pine.residence@ocbd.co.id</p>
          <p class="font-mono">Jln.Kaum Sari Kelurahan Cibuluh Kec.Bogor Utara</p>
        ...
        <!-- SOSMED -->
        <div class="w-full px-4 mb-12 md:w-1/3">
          <h3 class="font-semibold text-xl text-white mb-5 text-center">Social Media</h3>
          <ul class="flex items-center justify-center mb-5">
            ...
            <li>
              ...
              >
                <svg role="img" width="20" viewBox="0 0 24 24" class="fill-current" xmlns="http://www.w3.org/2000/svg">
